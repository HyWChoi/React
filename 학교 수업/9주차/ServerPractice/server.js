...
var userList = [
  ...
  { keyid: 2, name: "박길동", id: "kdpart", passwd: "1111" },
];
...
app.listen(65011, () => {
  console.log("express server is running on port 65010");
  console.log("-------------------------------------");
  console.log("  (리액트 연동용) 웹서버 실행 중...    ");
  console.log(" 접속 주소 : http://localhost:65011/ ");
  console.log("-------------------------------------");
});
